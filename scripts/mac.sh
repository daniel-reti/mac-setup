...
# Desktop background
step "Setting custom desktop background..."
BACKGROUND_PATH="$(pwd)/themes/background.jpg"
if [ -f "$BACKGROUND_PATH" ]; then
    osascript -e "tell application \"Finder\" to set desktop picture to POSIX file \"$BACKGROUND_PATH\""
    print_success_muted "Desktop background set to custom image"
else
    print_success_muted "Custom background image not found, skipping background setup"
fi
